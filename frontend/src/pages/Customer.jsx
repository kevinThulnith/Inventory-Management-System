...
function Customer() {
  ...
  return (
    <motion.div
      className="bg-white rounded-lg shadow-md sm:p-6 p-4 flex ms:flex-row flex-col ms:gap-6 gap-2 ms:w-[1150px] ss:w-[600px] form-container w-[380px] mx-auto overflow-y-auto ms:h-[620px] h-[650px]"
      initial="hidden"
      animate="visible"
